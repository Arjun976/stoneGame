...
function Home() {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-around pt-2">
      ...
      <div className={`p-2 absolute -top-20 w-[30svw] rounded-sm bg-green-500/30 border border-green-400 flex items-center transition-all ease-linear duration-500 gap-2 ${win?'top-10':'-top-50'}`}>
      ...
      <div className={`p-2 absolute -top-20 w-[30svw] rounded-sm bg-red-500/30 border border-red-400 flex items-center transition-all ease-linear duration-500 gap-2 ${(!win&&win!==null)?'top-10':'-top-50'}`}>
