...
function Home() {
  ...
  return (
    ...
    <div className="min-h-screen flex flex-col items-center justify-around pt-2">
      <p className='text-4xl'>STONE PAPER SCISSOR</p>
      <div className='p-4 w-svw h-svh flex items-center justify-center relative'>
      <div className={`p-2 absolute -top-20 w-[30svw] rounded-sm bg-green-500/30 border border-green-400 flex items-center transition-all ease-linear duration-500 gap-2 ${userWin?'top-10':'-top-50'}`}>
      ...
      <div className={`p-2 absolute -top-20 w-[30svw] rounded-sm bg-red-500/30 border border-red-400 flex items-center transition-all ease-linear duration-500 gap-2 ${systemWin?'top-10':'-top-50'}`}>
      ...
      <div className="flex items-center justify-center gap-8">
        <div className='flex flex-col gap-6'>
          ...
          {
      <p className='text-3xl'>Player Score:{scoreCountUser}</p>
      }
        </div>
        ...
        <div className='flex flex-col gap-6'>
         ...
         <p className='text-3xl '>AI Score:{scoreCountSystem}</p> 
        </div>
      </div>
      </div>
    </div>
